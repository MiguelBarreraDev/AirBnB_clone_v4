...
def number_odd_or_even_view(n):
    """
    View function for the dinamyx rule '/number_odd_or_even/<int:n>'
    that return a template
    """
    return render_template("6-number_odd_or_even.html", data={"number": n})
